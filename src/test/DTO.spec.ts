import CacheImageRequest, { BackgroundOptions, FitOptions, PositionOptions, ResizeOptions, SupportedResizeFormats } from '@microservice/API/DTO/CacheImageRequest'
import ManipulationJobResult from '@microservice/DTO/ManipulationJobResult'
import ResourceMetaData, {
	defaultPrivateTTL,
	defaultPublicTTL,
	resourceMetaVersion,
} from '@microservice/DTO/ResourceMetaData'
