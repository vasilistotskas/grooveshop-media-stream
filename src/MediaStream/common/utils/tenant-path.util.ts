 ...
 * the default 'public' tenant schema. Unanchored TENANT_SCHEMA_SEGMENT already rejects anything
 * that isn't a valid schema identifier, so an invalid/malformed segment falls through to
 * 'public' too — no separate validation needed here.
 */
