...
const unable_to_store_fetched_resource_exception_1 = __importDefault(require("../../API/exceptions/unable-to-store-fetched-resource.exception"));
...
let StoreResourceResponseToFileJob = StoreResourceResponseToFileJob_1 = class StoreResourceResponseToFileJob {
    ...
    async handle(resourceName, path, response) {
        if (!response.data || typeof response.data.pipe !== 'function') {
            ...
            throw new unable_to_store_fetched_resource_exception_1.default(resourceName);
        }
