...
export class StorageHealthIndicator extends BaseHealthIndicator {
    async performHealthCheck() {
        return this.executeWithTimeout(async ()=>{
            ...
            const details = {
                ...
                topFileTypes: Object.entries(stats.fileTypes).map(([extension, count])=>({
                        extension,
                        count
    ...
    generateCleanupRecommendations(stats, _thresholdCheck) {
        ...
        const largeFiles = stats.accessPatterns.filter((p)=>p.size > 1024 * 1024).sort((a, b)=>b.size - a.size).slice(0, 10);
...
StorageHealthIndicator = _ts_decorate([
    ...
    _ts_metadata("design:paramtypes", [
        ...
        typeof StorageCleanupService === "undefined" ? Object : StorageCleanupService
    ])
