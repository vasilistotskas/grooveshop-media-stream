...
import { AlertCondition, AlertSeverity } from "../../../MediaStream/Monitoring/interfaces/monitoring.interface.js";
import { MonitoringModule } from "../../../MediaStream/Monitoring/monitoring.module.js";
import { AlertService } from "../../../MediaStream/Monitoring/services/alert.service.js";
...
describe('monitoring Integration', ()=>{
    ...
    beforeAll(async ()=>{
        ...
        performanceService = app.get(PerformanceMonitoringService);
        controller = app.get(MonitoringController);
    });
    afterAll(async ()=>{
        await app.close();
    });
    ...
    describe('controller Integration', ()=>{
        ...
        it('should handle metric queries', ()=>{
            ...
            expect(metrics.name).toBe('api.response.size');
            ...
            expect(aggregated.sum).toBe(3584);
            expect(aggregated.avg).toBeCloseTo(1194.67, 1);
        });
    ...
    describe('performance Monitoring Integration', ()=>{
        ...
        it('should handle active operations tracking', ()=>{
            ...
            const op1 = performanceService.startOperation('long-running-1', {
                priority: 'high'
            });
            const op2 = performanceService.startOperation('long-running-2', {
                priority: 'low'
            });
...
//# sourceMappingURL=monitoring.integration.spec.js.map