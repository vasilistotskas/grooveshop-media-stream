...
describe('monitoringController', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        const mockPerformanceService = {
            ...
            getTrackedOperations: vi.fn().mockReturnValue([
                'operation1',
                'operation2'
            ]),
    ...
    describe('alert endpoints', ()=>{
        ...
        describe('triggerAlert', ()=>{
            it('should trigger manual alert', ()=>{
                ...
                expect(result.success).toBe(true);
                expect(alertService.triggerAlert).toHaveBeenCalledWith('Manual Alert', 'Test message', AlertSeverity.MEDIUM, {
                    source: 'manual'
                });
            });
        });
...
//# sourceMappingURL=monitoring.controller.spec.js.map