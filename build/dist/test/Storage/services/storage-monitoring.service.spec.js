...
describe('storageMonitoringService', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        service = module.get(StorageMonitoringService);
    ...
    describe('initialization', ()=>{
        it('should create storage directory if it does not exist', async ()=>{
            ...
            expect(mockFs.mkdir).toHaveBeenCalledWith(mockStorageDirectory, {
                recursive: true
            });
        });
...
//# sourceMappingURL=storage-monitoring.service.spec.js.map