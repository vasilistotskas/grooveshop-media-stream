...
describe('storageCleanupService', ()=>{
    ...
    describe('retention policies', ()=>{
        ...
        it('should apply old-cache-files policy correctly', async ()=>{
            ...
            expect(mockFs.unlink).not.toHaveBeenCalledWith(expect.stringContaining('recent-file.json'));
        });
    ...
    describe('scheduledCleanup', ()=>{
        it('should not run when disabled', async ()=>{
            configService.getOptional.mockImplementation((key, defaultValue)=>{
                if (key === 'storage.cleanup.enabled') return false;
                return defaultValue;
            });
...
//# sourceMappingURL=storage-cleanup.service.spec.js.map