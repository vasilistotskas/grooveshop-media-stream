...
import { StorageOptimizationService } from "../../../MediaStream/Storage/services/storage-optimization.service.js";
...
describe('storageOptimizationService', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        service = module.get(StorageOptimizationService);
    ...
    describe('compression strategy', ()=>{
        ...
        it('should create backups when configured', async ()=>{
            configService.getOptional.mockImplementation((key, defaultValue)=>{
                if (key === 'storage.optimization.createBackups') return true;
                const defaults = {
                    'storage.optimization.enabled': true,
                    'storage.optimization.strategies': [
                        'compression'
    ...
    describe('deduplication strategy', ()=>{
        beforeEach(async ()=>{
            ...
            vi.mocked(mockCrypto.createHash).mockReturnValue(mockHash);
    ...
    describe('scheduledOptimization', ()=>{
        it('should not run when disabled', async ()=>{
            ...
            const disabledConfigService = {
                ...
                getOptional: vi.fn().mockImplementation((key, defaultValue)=>{
                    if (key === 'storage.optimization.enabled') return false;
                    return defaultValue;
                })
            };
            ...
            const disabledService = disabledModule.get(StorageOptimizationService);
    ...
    describe('strategy configuration', ()=>{
        it('should use only configured strategies', async ()=>{
            ...
            const customConfigService = {
                ...
                getOptional: vi.fn().mockImplementation((key, defaultValue)=>{
                    if (key === 'storage.optimization.strategies') return [
                        'compression'
                    ];
                    const defaults = {
                        'storage.optimization.enabled': true,
            ...
            const customService = customModule.get(StorageOptimizationService);
        ...
        it('should respect popularity threshold configuration', async ()=>{
            ...
            const customConfigService = {
                ...
                getOptional: vi.fn().mockImplementation((key, defaultValue)=>{
                    if (key === 'storage.optimization.popularThreshold') return 100 // Very high threshold
                    ;
                    const defaults = {
                        'storage.optimization.enabled': true,
                        'storage.optimization.strategies': [
...
//# sourceMappingURL=storage-optimization.service.spec.js.map