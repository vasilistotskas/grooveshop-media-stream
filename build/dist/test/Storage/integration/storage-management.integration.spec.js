...
import { StorageModule } from "../../../MediaStream/Storage/storage.module.js";
    ...
    beforeAll(async ()=>{
        const mockConfigService = {
            get: vi.fn().mockImplementation((key)=>{
                if (key === 'cache.file.directory') return testStorageDir;
                return undefined;
            }),
        ...
        storageOptimization = module.get(StorageOptimizationService);
        ...
        mockFs.stat.mockImplementation((filePath)=>{
            ...
            switch(filename){
                ...
                case 'old-cache.json':
                    stats = {
                        size: 512 * 1024,
                        mtime: new Date(Date.now() - 25 * 24 * 60 * 60 * 1000),
    ...
    describe('end-to-End Storage Management Workflow', ()=>{
        ...
        it('should handle storage threshold escalation', async ()=>{
            ...
            expect([
                'warning',
                'critical'
            ]).toContain(thresholdCheck.status);
...
//# sourceMappingURL=storage-management.integration.spec.js.map