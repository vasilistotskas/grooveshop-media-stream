...
import { BackgroundOptions, FitOptions, PositionOptions, ResizeOptions, SupportedResizeFormats } from "../../../MediaStream/API/dto/cache-image-request.dto.js";
import ManipulationJobResult from "../../../MediaStream/Queue/dto/manipulation-job-result.dto.js";
...
describe('webpImageManipulationJob', ()=>{
    ...
    beforeEach(()=>{
        ;
        sharp.mockReturnValue(mockManipulation);
    ...
    describe('handle', ()=>{
        it('should handle webp format with quality', async ()=>{
            ...
            expect(mockManipulation.webp).toHaveBeenCalledWith({
                quality: 80
            });
...
//# sourceMappingURL=webp-image-manipulation.job.spec.js.map