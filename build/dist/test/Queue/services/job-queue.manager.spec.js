...
import { ImageProcessingProcessor } from "../../../MediaStream/Queue/processors/image-processing.processor.js";
...
import { JobPriority, JobType } from "../../../MediaStream/Queue/types/job.types.js";
...
describe('jobQueueManager', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        manager = module.get(JobQueueManager);
    ...
    describe('addImageProcessingJob', ()=>{
        it('should add image processing job with correlation ID', async ()=>{
            ...
            expect(mockQueueService.add).toHaveBeenCalledWith(JobType.IMAGE_PROCESSING, {
                ...jobData,
                correlationId: 'corr-123'
    ...
    describe('addCacheWarmingJob', ()=>{
        it('should add cache warming job with correlation ID', async ()=>{
            ...
            expect(mockQueueService.add).toHaveBeenCalledWith(JobType.CACHE_WARMING, {
                ...jobData,
                correlationId: 'corr-123'
            }, expect.objectContaining({
                priority: JobPriority.LOW,
    ...
    describe('addCacheCleanupJob', ()=>{
        it('should add cache cleanup job with correlation ID', async ()=>{
            ...
            expect(mockQueueService.add).toHaveBeenCalledWith(JobType.CACHE_CLEANUP, {
                ...jobData,
                correlationId: 'corr-123'
            }, expect.objectContaining({
                priority: JobPriority.LOW,
    ...
    describe('job processors', ()=>{
        ...
        it('should process image processing jobs successfully', async ()=>{
            ...
            const processorCall = mockQueueService.process.mock.calls.find((call)=>call[0] === JobType.IMAGE_PROCESSING);
        ...
        it('should process cache warming jobs successfully', async ()=>{
            ...
            const processorCall = mockQueueService.process.mock.calls.find((call)=>call[0] === JobType.CACHE_WARMING);
            const processor = processorCall[1];
            const result = await processor(mockJob);
        ...
        it('should process cache cleanup jobs successfully', async ()=>{
            ...
            const processorCall = mockQueueService.process.mock.calls.find((call)=>call[0] === JobType.CACHE_CLEANUP);
            const processor = processorCall[1];
            const result = await processor(mockJob);
    ...
    describe('updateMetrics', ()=>{
        it('should update metrics correctly for successful jobs', ()=>{
            ...
            const initialProcessingTimes = [
                ...initialMetrics.processingTimes
            ];
            manager.updateMetrics(true, 1500);
            expect(initialMetrics.completedJobs).toBe(initialCompleted + 1);
            expect(initialMetrics.processingTimes).toEqual([
        ...
        it('should update metrics correctly for failed jobs', ()=>{
            ...
            manager.updateMetrics(false, 2000);
        ...
        it('should limit processing times to 1000 entries', ()=>{
            ...
            metrics.processingTimes = Array.from({
                length: 1000
            }).fill(1000);
            manager.updateMetrics(true, 2000);
...
//# sourceMappingURL=job-queue.manager.spec.js.map