...
describe('adaptiveRateLimitGuard', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        const module = await Test.createTestingModule({
            providers: [
                ...
                {
                    provide: RateLimitMetricsService,
                    useValue: mockRateLimitMetricsService
                }
            ]
        }).compile();
        guard = module.get(AdaptiveRateLimitGuard);
    ...
    describe('canActivate', ()=>{
        ...
        it('should apply adaptive rate limiting', async ()=>{
            ...
            expect(rateLimitService.checkRateLimit).toHaveBeenCalledWith('192.168.1.1:hash:image-processing', {
                ...mockConfig,
                max: 50
            });
        });
        ...
        it('should extract client IP from various headers', async ()=>{
            ...
            for (const testCase of testCases){
                ...
                expect(rateLimitService.generateAdvancedKey).toHaveBeenCalledWith(testCase.expectedIp, expect.any(String), 'image-processing');
                vi.clearAllMocks();
            }
        });
        it('should identify different request types correctly', async ()=>{
            const testCases = [
                {
                    url: '/api/v1/image/media/uploads/test.jpg/100/100/contain/entropy/transparent/5/webp/100',
                    expectedType: 'image-processing'
                },
                {
                    url: '/api/v1/image/static/images/test.jpg/100/100/contain/entropy/transparent/5/webp/100',
                    expectedType: 'image-processing'
                },
                {
                    url: '/health',
...
//# sourceMappingURL=adaptive-rate-limit.guard.spec.js.map