import { CircuitBreakerConfigDto, ConnectionPoolConfigDto, HttpConfigDto, RetryConfigDto } from "../../../MediaStream/Config/dto/http-config.dto.js";
...
describe('hTTP Config DTOs', ()=>{
    describe('circuitBreakerConfigDto', ()=>{
        ...
        it('should handle boolean transformation for enabled field', ()=>{
            ...
            testCases.forEach(({ input, expected })=>{
                const config = plainToClass(CircuitBreakerConfigDto, {
                    enabled: input
                });
    ...
    describe('connectionPoolConfigDto', ()=>{
        ...
        it('should handle boolean transformation for keepAlive field', ()=>{
            ...
            testCases.forEach(({ input, expected })=>{
                const config = plainToClass(ConnectionPoolConfigDto, {
                    keepAlive: input
                });
    ...
    describe('retryConfigDto', ()=>{
        ...
        it('should handle boolean transformations', ()=>{
            ...
            testCases.forEach(({ input, expected })=>{
                const config1 = plainToClass(RetryConfigDto, {
                    retryOnTimeout: input
                });
                const config2 = plainToClass(RetryConfigDto, {
                    retryOnConnectionError: input
                });
...
//# sourceMappingURL=http-config.dto.spec.js.map