import { DefaultImageFallbackError, InvalidRequestError, MediaStreamError, ResourceNotFoundError, ResourceProcessingError, ResourceStreamingError } from "../../../MediaStream/common/errors/media-stream.errors.js";
...
describe('mediaStreamErrors', ()=>{
    describe('mediaStreamError', ()=>{
        ...
        it('should create a base error with custom values', ()=>{
            ...
            const error = new MediaStreamError('Custom error', HttpStatus.BAD_REQUEST, 'CUSTOM_ERROR', context);
...
//# sourceMappingURL=media-stream.errors.spec.js.map