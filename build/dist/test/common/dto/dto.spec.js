...
import ResourceMetaData, { defaultPrivateTTL, defaultPublicTTL, resourceMetaVersion } from "../../../MediaStream/HTTP/dto/resource-meta-data.dto.js";
...
describe('resizeOptions', ()=>{
    ...
    it('should accept custom values', ()=>{
        ...
        expect(resizeOptions.background).toEqual({
            r: 255,
            g: 0,
            b: 0,
            alpha: 1
