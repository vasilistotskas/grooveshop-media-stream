import { DefaultCacheKeyStrategy } from "../../../MediaStream/Cache/strategies/cache-key.strategy.js";
...
describe('defaultCacheKeyStrategy', ()=>{
    ...
    describe('generateKey', ()=>{
        ...
        it('should generate consistent keys for same parameters', ()=>{
            const key1 = strategy.generateKey('images', 'test-image', {
                width: 100,
                height: 200
            });
            const key2 = strategy.generateKey('images', 'test-image', {
                width: 100,
                height: 200
            });
...
//# sourceMappingURL=cache-key.strategy.spec.js.map