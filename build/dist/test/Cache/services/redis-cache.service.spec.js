    ...
    beforeEach(async ()=>{
        ...
        const mockConfigService = {
            get: vi.fn().mockImplementation((key)=>{
                if (key === 'cache.redis') return mockConfig;
    ...
    describe('cache operations', ()=>{
        ...
        describe('getStats', ()=>{
            it('should return cache statistics', async ()=>{
                mockRedis.info.mockImplementation((...args)=>{
                    const section = args[0];
                    if (section === 'keyspace') return Promise.resolve('db0:keys=100,expires=50');
                    if (section === 'memory') return Promise.resolve('used_memory:1048576');
