...
describe('metrics Integration', ()=>{
    ...
    describe('metrics Health Endpoint', ()=>{
        it('should provide health status at /metrics/health', async ()=>{
            const response = await request(app.getHttpServer()).get('/metrics/health').expect(200);
        ...
        it('should track requests in flight during concurrent requests', async ()=>{
            ...
            try {
                ...
                for(let i = 0; i < requestCount; i++){
                    await request(app.getHttpServer()).get('/metrics/health').timeout(5000).expect(200);
                ...
                await new Promise((resolve)=>setTimeout(resolve, 100));
                const response = await request(app.getHttpServer()).get('/metrics').timeout(5000).expect(200);
...
//# sourceMappingURL=metrics.integration.spec.js.map