...
import { CorrelationId, RequestContext } from "../../../MediaStream/Correlation/decorators/correlation.decorator.js";
...
describe('correlation Decorators', ()=>{
    ...
    beforeEach(()=>{
        ...
        CorrelationService.mockImplementation(()=>mockCorrelationService);
    });
    afterEach(()=>{
        vi.clearAllMocks();
    });
    describe('correlationId decorator', ()=>{
        it('should return correlation ID from service', ()=>{
            ...
            const result = CorrelationId(undefined, mockExecutionContext);
        ...
        it('should create new CorrelationService instance each time', ()=>{
            ...
            CorrelationId(undefined, mockExecutionContext);
            CorrelationId(undefined, mockExecutionContext);
    ...
    describe('requestContext decorator', ()=>{
        it('should return request context from service', ()=>{
            ...
            const result = RequestContext(undefined, mockExecutionContext);
        ...
        it('should create new CorrelationService instance each time', ()=>{
            ...
            RequestContext(undefined, mockExecutionContext);
            RequestContext(undefined, mockExecutionContext);
            expect(CorrelationService).toHaveBeenCalledTimes(2);
        });
    });
    describe('decorator integration', ()=>{
        it('should work with different execution contexts', ()=>{
            ...
            const httpResult = CorrelationId(undefined, httpContext);
            const rpcResult = CorrelationId(undefined, rpcContext);
        ...
        it('should ignore data parameter', ()=>{
            ...
            const result1 = CorrelationId('some-data', mockExecutionContext);
            const result2 = CorrelationId({
                key: 'value'
            }, mockExecutionContext);
            const result3 = CorrelationId(null, mockExecutionContext);
    ...
    describe('error handling', ()=>{
        it('should handle CorrelationService errors gracefully', ()=>{
            ...
            expect(()=>CorrelationId(undefined, mockExecutionContext)).toThrow('Service error');
        });
        it('should handle context service errors gracefully', ()=>{
            mockCorrelationService.getContext.mockImplementation(()=>{
                throw new Error('Context error');
            });
            expect(()=>RequestContext(undefined, mockExecutionContext)).toThrow('Context error');
        });
    });
});

//# sourceMappingURL=correlation.decorator.spec.js.map