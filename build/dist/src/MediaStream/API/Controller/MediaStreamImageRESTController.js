...
let MediaStreamImageRESTController = (MediaStreamImageRESTController_1 = class MediaStreamImageRESTController {
	...
	async uploadedImage(
		...
		const request = new CacheImageRequest_1.default({
			resourceTarget: MediaStreamImageRESTController_1.resourceTargetPrepare(
...
__decorate(
	[
		(0, common_1.Get)(
			'media/uploads/:imageType/:image/:width?/:height?/:fit?/:position?/:background?/:trimThreshold?/:format?'
		),
	...
	MediaStreamImageRESTController.prototype,
	'uploadedImage',
	null
)
__decorate(
